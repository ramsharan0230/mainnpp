...
{
    protected $onlineLibrary;
    public function __construct(OnlineLibraryInterface $onlineLibrary)
    {
    ...
    public function index(Request $request){
        try {
            ...
            $data = $this->onlineLibrary->getAllWithParam($parameter, $path);
    ...
    {
        try {
            $data = $this->onlineLibrary->getSpacificLibraryBySlug($slug);
            return response()->json([
                "status" => "200",
                "payload" => $data
            ], 200);

...
@section('content')
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <h1 class="text-center">सूचना तथा समाचार</h1>
        </div>
    </section><!-- End Hero -->
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="press-box mt-2">
                            <div class="press-content">
                                ...
                                <div class="row">
                                    <div class="col-lg-2 ">
                                        <img src="{{asset($item->banner)}}" alt="" class="img-fluid">

                                    </div>
                                    <div class="col-lg-10 ">
                                        <div class="views-field views-field-created">
                                            <span class="views-label views-label-created">Post date: </span>
                                            <span class="field-content"><em class="placeholder">{{$item->start_date}}</em> ago</span>
                                        </div>
                                        ...
                                        <div class="news-describe">
                                            ...
                                            <div class="read-more mt-3">
                                                <a href="{{route('news.detail',$item->slug)}}" class="btn-learn-more">थप पढ्नुहोस्

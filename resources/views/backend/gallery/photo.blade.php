            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Photo
                            <a class="btn btn-sm btn-outline-secondary" href="{{route('gallery.create')}}"><i class="icon-plus"></i> Add Photo</a></h2>
                    </div>
                </div>
            </div>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    @foreach($photo as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{asset($item->photo)}}" style="max-width: 100px">
                                            </td>

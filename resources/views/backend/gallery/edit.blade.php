            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Edit Gallery</h2>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-12 col-sm-12">
                                        ...
                                        <select name="gallery_type" id="gallery_type" class="form-control show-tick">
                                            ...
                                            <option value="photo" {{$gallery->gallery_type=='photo' ? 'selected' : ''}}>Photo</option>
                                    ...
                                    <div class="col-lg-12 col-md-12 photo">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="title_input" class="form-control" placeholder="Title" name="photo_title" value="{{$gallery->photo_title}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 video">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="video_input" class="form-control" placeholder="Video Iframe Url" name="video_url" value="{{$gallery->video_url}}">
                                        </div>
                                    </div>

                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    @foreach($applicants as $item)
                                        <tr>
                                            ...
                                            <td>{{\App\Models\Vacancy::find($item->vacancy_id)->title}}</td>
                                            ...
                                            <td>
                                                    ...
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Position
                                                                    <strong class="text-info">{{\App\Models\Vacancy::find($item->vacancy_id)->title}}</strong></h4>
                                                ...
                                                <form class="float-left ml-1" action="{{route('applicants.delete',$item->id)}}"  method="post">
                                                    @csrf
                                                    @method('delete')

                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Banner heading" name="title" value="{{$category->title}}" id="title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <label for="">URL</label>
                                            <input type="text" class="form-control" placeholder="URL" name="slug" value="{{$category->slug}}" id="slug">
                                        </div>
                                    </div>
